      ...
      <form novalidate>
        <ion-list>
          ...
          <ion-item>
            ...
            <ion-input data-testid="login-passwor" v-model="password" name="password" type="password" required></ion-input>
          </ion-item>
        ...
        <ion-row responsive-sm>
          ...
          <ion-col>
            <ion-button @click="onSignup()" color="light" expand="block" data-testid="login-signup">Signup</ion-button>
          </ion-col>
        </ion-row>
      </form>
    </ion-content>
